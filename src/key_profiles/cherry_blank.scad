...
module cherry_blank_row(row=3, column=0) {
  ...
  $blank_adjustment = 0.5 * $dish_depth;
    
  $bottom_key_width = 18.16 - $blank_adjustment;
  $bottom_key_height = 18.16 - $blank_adjustment;
  ...
  // $stem_inset = 0.6;
  extra_stem_inset_height = max(0.6 - $stem_inset, 0) + $blank_adjustment;
